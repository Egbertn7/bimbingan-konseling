...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white rounded-lg shadow-lg p-6 w-96">
        <h1 class="text-2xl font-bold text-center mb-6">Registrasi sebagai Admin</h1>
        <form action="{{ route('register.admin') }}" method="POST">
            @csrf
            <div class="mb-4">
                <label for="nama_admin" class="block text-gray-700">Nama</label>
            ...
            <div class="text-center mt-4">
                <a href="{{ route('home') }}"
                    class="bg-gray-600 px-4 py-2 text-white font-semibold rounded-md shadow-lg hover:bg-gray-800 transition duration-200 inline-block w-full text-center">Kembali
                    ke Halaman Utama</a>
            </div>
        </form>
    </div>
