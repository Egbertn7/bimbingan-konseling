...
@section('titlle', 'Halaman Bimbingan Konseling')
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white rounded-lg shadow-lg p-8 md:p-12 lg:p-16 w-full max-w-3xl mx-4">
        ...
        <p class="text-center text-gray-500 mb-10">
            Selamat datang di platform bimbingan konseling kami. Silakan login atau register sebagai User atau Admin.
        </p>
            ...
            <div class="text-center">
                ...
                <div class="flex justify-around mt-4">
                    <a href="{{ route('login.user') }}"
                        class="bg-blue-500 px-6 py-3 text-white font-semibold rounded-full shadow-lg hover:bg-blue-600 transition duration-200">
                        Login User
                    </a>
